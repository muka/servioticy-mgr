...
Component.prototype.ready = function() {
    var me = this;
    d("Waiting for service to became ready")
...
Component.prototype.status = function() {
    return this.config.status().then(function(running) {
        d(running ? "Already running" : "Not running");
        return Promise.resolve(running);
    });
};
...
Component.prototype.needSetup = function() {
    return typeof cache[this.name] === 'undefined';
};
