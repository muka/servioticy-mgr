...
module.exports.replicaSetup = function(component) {

    console.log("Restarting couchbase XDCR");
            ...
            if(res.length) {
                ...
                if(list.length) {
                    return Promise.all(list)
                        .map(_removeXDCR)
                        .then(function(res) {
                            console.log("Removed replica res", res);
                            return _createXDCR();
                        });
                }
...
//                console.log(response);
        ...
        .then(function() {
            ...
            module.exports.replicaSetup(component);
